...
public class Main_usunOcene {
    public static void main(String[] args) {
        ...
        try (Session session = HibernateUtil.INSTANCE.getSessionFactory().openSession()) {
            ...
            // pytamy użytkownika czy chce usunąć ocene czy studenta
            ...
            if (encjaUsuwana.equalsIgnoreCase("ocena")) {
                ...
                System.out.println("Podaj id oceny którą chcesz usunać:");
                String id = scanner.nextLine();
                Long ocenaId = Long.parseLong(id);

                // następnie szukamy tej oceny
                ...
                // jeśli odpowie studenta, to pytamy o id studenta
